...
import InputButton from '../constants/InputButton';
  ...
  return (
    <div className="px-5 py-7 sm:ml-64">
        ...
        <section className='mb-7'>
          <h5 className='h5 mb-1'>New User</h5>
            ...
            <div className="sign-form absolute top-16 left-16">
              <div className="Card w-96 p-6 bg-white rounded-2xl flex-col justify-start items-start gap-8 inline-flex">
                ...
                <div className="self-stretch flex-col justify-start items-start gap-4 flex">
                  <InputButton type='text' name='name' placeholder='Full Name' />
                  <InputButton type='email' name='email' placeholder='Email Address' />
                  <InputButton type='password' name='password' placeholder='Password' />
                  <InputButton type='password' name='confirm_password' placeholder='Confirm Password' />
                </div>
