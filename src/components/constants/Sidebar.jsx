        ...
        <>
            ...
            >
                <div className="h-full px-5 py-4 overflow-y-auto sidebar">
                    <Link
                        to='/'
                        className="flex items-center mb-5 mt-2 brand"
                    >
                        <span>
                            Bir
                        </span>
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link
                                to='/home'
                                className={`btn ${currentLocaion.pathname === '/home' ? 'active' : ''}`}
                            >
                        ...
                        <li>
                            <Link
                                to='how_it_works'
                                className={`btn ${currentLocaion.pathname === '/how_it_works' ? 'active' : ''}`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                        ...
                        <li>
                            <Link
                                to='sign_in'
                                className={`btn ${currentLocaion.pathname === '/sign_in' ? 'active' : ''}`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" >
                        ...
                        <li>
                            <Link
                                to='create_account'
                                className={`btn ${currentLocaion.pathname === '/create_account' ? 'active' : ''}`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" >
                        ...
                        <li>
                            <Link
                                to='app_demo'
                                className={`btn ${currentLocaion.pathname === '/app_demo' ? 'active' : ''}`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" >
                        ...
                        <li>
                            <Link
                                to='my_account'
                                className={`btn ${currentLocaion.pathname === '/my_account' ? 'active' : ''}`}
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                        ...
                        <li>
                            <Link
                                ...
                                style={{ border: "1px solid #1E293B", borderRadius: "32px", color: "white", fill: "white" }}
                            >
